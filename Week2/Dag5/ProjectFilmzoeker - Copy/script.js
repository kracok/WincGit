...
// //een function met alle films
// function addMoviesToDom(){
//   return movies.Title;
// }

//met onderstaande code worden alle films met afbeelding in de DOM gezet
  //een array met alle film afbeeldingen
// const moviePosters = movies.map(hero => {
//   return hero.Poster;
// })
  
//   //met de onderstaande code wordt de filmlijst in de DOM gezet
// const ulList = document.getElementById('movieContainer');
  
// for (let film of moviePosters) {
...
function removeEverything(){
  const listName = document.getElementById("movieContainer");
  listName.innerHTML = '';
}
...
const addAvengersMoviesToDom = function addAvengersMoviesToDom() {
  const avengerMovies = movies.filter(name => name.Title.includes('Avengers'));

  avengerMovies.forEach(function(movie) {
    let a   = document.createElement('a');
    let img = document.createElement("img");
    a.href  = 'http://www.imdb.com/title/' + movie.imdbID;
    img.src = movie.Poster;
...
const addXmenMoviesToDom = function addXmenMoviesToDom() {
...
const addBatmanMoviesToDom = function addBatmanMoviesToDom() {
...
const addPrincessMoviesToDom = function addPrincessMoviesToDom() {
...
function addEventListener() {
  let newerMovies = document.querySelector('#containMovies #buttonNewer');
  let avengerMovies = document.querySelector('#containMovies #buttonAvengers');
  let xmenMovies = document.querySelector('#containMovies #buttonXmen');
  let batmanMovies = document.querySelector('#containMovies #buttonBatman');
  let princessMovies = document.querySelector('#containMovies #buttonPrincess');

  batmanMovies.addEventListener('change', function(){
    console.log('button clicked');
    removeEverything()
    addBatmanMoviesToDom()
  })

  princessMovies.addEventListener('change', function(){
    console.log('button clicked');
    removeEverything()
    addPrincessMoviesToDom()
  })

  xmenMovies.addEventListener('change', function(){
    console.log('button clicked');
    removeEverything()
    addXmenMoviesToDom()
  })

  avengerMovies.addEventListener('change', function(){
    console.log('button clicked');
    removeEverything()
    addAvengersMoviesToDom()
  })

  newerMovies.addEventListener('change', function(){
    console.log('button clicked');
    removeEverything()
...
// //een array met alle film namen
// const movieNames = movies.map(hero => {
//   return hero.Title;
// });

// const batmanMovies = movieNames.filter(name => name.includes('Batman'));
// console.log(batmanMovies);

// const avengersMovies = movieNames.filter(name => name.includes('Avengers'));
// console.log(avengersMovies);

// const xmenMovies = movieNames.filter(name => name.includes('X-Men'));
// console.log(xmenMovies);

// const princessMovies = movieNames.filter(name => name.includes('Princess'));
...
// //met onderstaande code wordt een lijst met alle film namen in de DOM gezet
//   //een array met alle film namen
// const movieNames = movies.map(hero => {
//   return hero.Title;
// })

//   //hiermee worden alle batman films gefilterd
// const batmanMovies = movieNames.filter(name => name.includes('Batman'));

//   //met de onderstaande code wordt de filmlijst in een <li> de DOM gezet
// const ulList = document.getElementById('movieContainer');

// for (let film of batmanMovies) {
//   let newItem = document.createElement('li');
//   newItem.textContent = film;
